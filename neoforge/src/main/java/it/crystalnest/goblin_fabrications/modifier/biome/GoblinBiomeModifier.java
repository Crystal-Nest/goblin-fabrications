...
public record GoblinBiomeModifier(HolderSet<Biome> biomes, int value) implements BiomeModifier {
  ...
  public void modify(Holder<Biome> biome, Phase phase, ModifiableBiomeInfo.BiomeInfo.Builder builder) {
    ...
    if (phase == Phase.ADD && biomes.contains(biome)) {
      builder.getMobSpawnSettings().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(GOBLIN_EXPLORER.get(),1,2,4));
    }
  }
  ...
  public static final Holder<MapCodec<? extends BiomeModifier>> GOBLIN_BIOME_MODIFIER =
    BIOME_MODIFIERS.register("goblin_biome_modifier", () -> RecordCodecBuilder.mapCodec(instance ->
      instance.group(
        Biome.LIST_CODEC.fieldOf("biomes").forGetter(GoblinBiomeModifier::biomes),
        Codec.INT.fieldOf("spawn_weight").forGetter(GoblinBiomeModifier::spawnWeight)
